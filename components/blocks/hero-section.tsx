          ...
          >
            ...
            <div className="flex w-full items-center justify-between lg:w-auto lg:justify-start lg:gap-10">
              ...
              <button
                ...
                className="relative z-20 flex items-center justify-center w-10 h-10 -mr--1 lg:hidden text-rosewood-deep transition-transform duration-300 active:scale-95 translate-y-0.5"
              >
